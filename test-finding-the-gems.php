...
if (isset($_GET['lesson_id']) && !empty($action->database->text_filter($_GET['lesson_id']))) {
    ...
    $select_find_gems_id = $action->database->query_sql("SELECT * FROM `tbl_finding_the_gems` WHERE lesson_id = '{$lesson_id}' AND status = 1;");
    if($select_find_gems_id){
    }
} else {
...
<div class="appHeader bg-primary text-light">
  ...
  <div class="pageTitle">Find The Gems</div>
  <div class="right">
  </div>
</div>
<!-- * App Header -->
...
<script>
  ...
  answer_the_questions_list = <?= json_encode($select_find_gems_id); ?>;
