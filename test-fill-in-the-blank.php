...
if (isset($_GET['lesson_id']) && !empty($action->database->text_filter($_GET['lesson_id']))) {
    ...
    $select_fill_blank_id = $action->database->query_sql("SELECT * FROM `tbl_fill_in_the_blank` WHERE lesson_id = '{$lesson_id}' AND status = 1;");
    if($select_fill_blank_id){
    }
} else {
...
<div class="appHeader bg-primary text-light">
  ...
  <div class="pageTitle">Fill Blank Test</div>
  <div class="right">
  </div>
</div>
<!-- * App Header -->
...
<script>
  ...
  answer_the_questions_list = <?= json_encode($select_fill_blank_id); ?>;
