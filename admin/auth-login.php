                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="index.html" class="d-block auth-logo">
                                        <img src="./assets/images/gg.png" alt="" height="40"> 
                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <form class="mt-4 pt-2" id="login_form_id">
                                        <div class="mb-3">
                                            <label class="form-label">Useremail</label>
                                            <input type="text" class="form-control" name="user_email" id="username" placeholder="Enter Your Useremail .....">
                                        </div>
                                        <div class="mb-3">
