            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Add Find Out The Correct Sentence List</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="find-out-the-correct-sentence.php">Find Out The Correct Sentence List</a></li>
                                <li class="breadcrumb-item active">Find Out The Correct Sentence List</li>
                            </ol>
                        </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Find Out The Correct Sentence</h4>
                        </div>
                        <div class="card-body">
                            <form class="needs-validation" id="find_correct_sentence_form_data">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
