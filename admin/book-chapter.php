            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Book Chapter List</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);"></a></li>
                                <li class="breadcrumb-item active">Book Chapter List</li>
                            </ol>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm">
                                    <div class="mb-4">
                                        <a href="add-book-chapter.php"><button class="btn btn-light waves-effect waves-light"><i class="bx bx-plus me-1"></i> Add Book Chapter</button></a>
                                    </div>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table id="table-data" class="table table-bordered dt-responsive  nowrap w-100">
                                    ...
                                    <tbody id="load_book_chapter_data">
