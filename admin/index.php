...
if (in_array("All", $roleview) || in_array("All", $roleview)) {
?>
    <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                        ...
                        <div class="card card-h-100">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <span class="text-muted mb-3 lh-1 d-block text-truncate">My
                                            Wallet</span>
                                        <h4 class="mb-3">
                    ...
                    <div class="col-xl-3 col-md-6">
                        ...
                        <div class="card card-h-100">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <span class="text-muted mb-3 lh-1 d-block text-truncate">Number
                                            of Trades</span>
                                        <h4 class="mb-3">
                                ...
                                <div class="text-nowrap">
                                    <span class="badge bg-danger-subtle text-danger">-29
                                        Trades</span>
                                    <span class="ms-1 text-muted font-size-13">Since
                                        last week</span>
                                </div>
                        ...
                        <div class="card card-h-100">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap align-items-center mb-4">
                                    <h5 class="card-title me-2">Wallet
                                        Balance</h5>
                                    <div class="ms-auto">
                                        <div>
                                ...
                                <div class="card card-h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-sm align-self-center">
                                                <div class="mt-4 mt-sm-0">
                                                    <p class="mb-1">Invested
                                                        Amount</p>
                                                    <h4>$ 6134.39</h4>

                                                    <p class="text-muted mb-4">
                                                        + 0.0012.23 (
                                                        0.2 % ) <i class="mdi mdi-arrow-up ms-1 text-success"></i></p>
                                                ...
                                                <div class="carousel-item active">
                                                    <div class="text-center p-4">
                                                        ...
                                                        <h4 class="mt-3 lh-base fw-normal text-white"><b>Bitcoin</b>
                                                            News</h4>
                                                        <p class="text-white-50 font-size-13">Bitcoin
                                                            prices fell
                                                            sharply amid
                                                            the global
                                                            sell-off in
                ...
                <div class="row">
                    <div class="col-xl-8">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap align-items-center mb-4">
                                    <h5 class="card-title me-2">Market
                                        Overview</h5>
                                    <div class="ms-auto">
                                        <div>
                                            <button type="button" class="btn btn-soft-primary btn-sm">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-xl-4">
                                        <div class="p-4">
                                            ...
                                            <div class="mt-4 pt-2">
                                                <a href="#" class="btn btn-primary w-100">See
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap align-items-center mb-4">
                                    <h5 class="card-title me-2">Sales by
                                        Locations</h5>
                                    <div class="ms-auto">
                                        <div class="dropdown">
                                            <a class="dropdown-toggle text-reset" href="#" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <span class="text-muted font-size-12">Sort
                                                    By:</span> <span class="fw-medium">World<i class="mdi mdi-chevron-down ms-1"></i></span>
                                            </a>
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="buy-tab" role="tabpanel">
                                        ...
                                        <h5 class="font-size-14 mb-4">Buy
                                            Coins</h5>
                                        <div>
                                    ...
                                    <div class="tab-pane" id="sell-tab" role="tabpanel">
                                        ...
                                        <h5 class="font-size-14 mb-4">Sell
                                            Coins</h5>
                                            ...
                                            <table class="table align-middle table-nowrap table-borderless">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <h5 class="font-size-14 mb-1">Buy
                                                                    BTC</h5>
                                                        ...
                                                        <td>
                                                            <div class="text-end">
                                                                <h5 class="font-size-14 mb-0">0.016
                                                                    BTC</h5>
                                                                <p class="text-muted mb-0 font-size-12">Coin
                                                                    Value</p>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <h5 class="font-size-14 mb-1">Sell
                                                                    ETH</h5>
                                                        ...
                                                        <td>
                                                            <div class="text-end">
                                                                <h5 class="font-size-14 mb-0">0.56
                                                                    ETH</h5>
                                                                <p class="text-muted mb-0 font-size-12">Coin
                                                                    Value</p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="text-end">
                                                                <h5 class="font-size-14 mb-0">1.88
                                                                    LTC</h5>
                                                                <p class="text-muted mb-0 font-size-12">Coin
                                                                    Value</p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="text-end">
                                                                <h5 class="font-size-14 mb-0">0.42
                                                                    ETH</h5>
                                                                <p class="text-muted mb-0 font-size-12">Coin
                                                                    Value</p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="text-end">
                                                                <h5 class="font-size-14 mb-0">0.018
                                                                    BTC</h5>
                                                                <p class="text-muted mb-0 font-size-12">Coin
                                                                    Value</p>
                                                            </div>
                    ...
                    <div class="col-xl-4">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">Recent
                                    Activity</h4>
                                <div class="flex-shrink-0">
        ...
        <div class="main-content">
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row" style="justify-content: center; margin: 8rem;opacity: 0.5;">
                        
                            <?php
                            $select_logo = $action->database->query_sql("SELECT * FROM `tbl_setting`");
                            if ($select_logo) {
                                foreach ($select_logo as $data_logo) {
                                }
                            }
                            ?>
                            <img src="../upload/<?= @$data_logo['logo'] ?>" alt="">
                            <!-- end card -->
                        </div>
                        <!-- end col -->
                    </div><!-- end row -->
