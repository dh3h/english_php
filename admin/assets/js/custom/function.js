...
/* --------------  stock Active Inactive Code  For Php  --------------- */
function check_stock(button_class, load_data_id, load_data_url, table_name) {
  $(document).on("click", button_class, function () {
    if ($(this).prop("checked") == true) {
      let active = $(this).data("checkid");
      ...
      $.ajax({
        type: "POST",
        url: "inc/config/Status_stock.php",
        data: { active: active, table_name: table_name },
        success: function (data) {
...
/* --------------  stock Active Inactive Code  For Php  --------------- */
function check_w_show(button_class, load_data_id, load_data_url, table_name) {
  $(document).on("click", button_class, function () {
    if ($(this).prop("checked") == true) {
      let active = $(this).data("checkid");
