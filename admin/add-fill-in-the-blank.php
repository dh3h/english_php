            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Add Fill In the Blanks</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="fill-in-the-blank.php">Fill In The Blank List</a></li>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Fill In the Blanks</h4>
                        </div>
                        <div class="card-body">
                            <form class="needs-validation" id="fill_in_the_blank_form">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
