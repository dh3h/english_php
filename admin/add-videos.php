            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Add Video's</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="videos.php">Video's List</a></li>
                                <li class="breadcrumb-item active">Video's</li>
                            </ol>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="needs-validation" id="videos_form_data">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label">Video's Title :</label>
                                            <input type="text" name="videos_title" class="form-control" placeholder="Enter Video's Title Here..">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label">Video's Link :</label>
                                            <input type="text" name="videos_link" class="form-control" placeholder="Enter Video's Link Here..">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="mb-3">
