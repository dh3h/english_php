            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Add Answer The Questions</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="answer-the-questions.php">Answer The Questions List</a></li>
                                <li class="breadcrumb-item active">Answer The Questions</li>
                            </ol>
                        </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Answer The Questions</h4>
                        </div>
                        <div class="card-body">
                            <form class="needs-validation" id="answer_the_questions_form_data">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
