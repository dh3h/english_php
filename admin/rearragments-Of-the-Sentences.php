            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Rearragments Of The Sentences List</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);"></a></li>
                                <li class="breadcrumb-item active">Rearragments Of The Sentences List</li>
                            </ol>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form class="needs-validation" id="rearragments_Of_the_Sentences_submit_data">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="mb-3">
                                                            <input type="text" class="form-control" name="rearragments_text" placeholder="Enter Rearragments here">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                            ...
                            <div class="table-responsive">
                                <table id="table-data" class="table table-bordered dt-responsive  nowrap w-100">
                                    ...
                                    <tbody id="load_rearragments_data">
