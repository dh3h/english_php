...
if (isset($_GET['lesson_id']) && !empty($action->database->text_filter($_GET['lesson_id']))) {
    ...
    $select_ans_quest_id = $action->database->query_sql("SELECT * FROM `tbl_answer_the_questions` WHERE lesson_id = '{$lesson_id}' AND status = 1;");
    if($select_ans_quest_id){
    }
} else {
...
<div class="appHeader bg-primary text-light">
  ...
  <div class="pageTitle">Ans The Question</div>
  <div class="right">
  </div>
</div>
<!-- * App Header -->
...
<script>
  ...
  answer_the_questions_list = <?= json_encode($select_ans_quest_id); ?>;
