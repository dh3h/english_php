...
if (isset($_GET['lesson_id']) && !empty($action->database->text_filter($_GET['lesson_id']))) {
    ...
    $select_listen_select_id = $action->database->query_sql("SELECT * FROM `tbl_listen_select_the_correct_sentence` WHERE lesson_id = '{$lesson_id}' AND status = 1;");
    if ($select_listen_select_id) {
    }
} else {
...
<div class="appHeader bg-primary text-light">
    ...
    <div class="pageTitle">Listen & Select</div>
    <div class="right">
    </div>
</div>
<!-- * App Header -->
...
<script>
    ...
    answer_the_questions_list = <?= json_encode($select_listen_select_id); ?>;
